...
const COURSES = [
    ...
    { category: 'A Level', courses: ['Science', 'Non-Science',] },
];
...
const ApplyForm = () => {
    ...
    const validate = () => {
        ...
        else if (parseFloat(formData.gpa) < 0 || parseFloat(formData.gpa) > 4) tempErrors.gpa = "GPA must be between 0 and 4.0.";
                    ...
                    <div className="form-container">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="input-boxes">
                                ...
                                <input id="gpa" type="number" placeholder="GPA" step="0.01" min="0" max="4" value={formData.gpa} onChange={handleChange} />
                                        ...
                                        {COURSES.map(group => (
                                            <optgroup key={group.category} label={group.category}>
                                                {group.courses.map(course => (
                                                    <option key={`${group.category}-${course}`} value={`${group.category} - ${course}`}>
                                                        {course}
                                                    </option>
                                                ))}
                                            </optgroup>
